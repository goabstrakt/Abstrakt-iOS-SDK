...
SWIFT_CLASS("_TtC7Logging3Log")
@interface Log : NSObject <BITHockeyManagerDelegate>
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
- (NSString * _Null_unspecified)applicationLogForCrashManager:(BITCrashManager * _Null_unspecified)crashManager SWIFT_WARN_UNUSED_RESULT;
@end
